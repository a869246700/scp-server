...
public class Dynamic implements Serializable {
    ...
    // private List<DynamicDiscuss> dynamicDiscussList; // 动态评论
    // private List<DynamicLikes> dynamicLikesList; // 动态点赞
    // private List<DynamicResource> dynamicResourceList; // 动态资源列表
}
